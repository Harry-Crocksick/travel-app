    ...
    return (
        <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
            ...
            <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
                ...
                <h1 className="bold-52 lg:bold-88">Arena Tour <br/> Camp Area</h1>
                ...
                <div className="flex flex-col w-full gap-3 sm:flex-row">
                    <Button type="button" title="Download App" variant="btn_green"></Button>
                    <Button type="button" title="How we work?" icon="/play.svg" variant="btn_white_text"></Button>
                </div>
            </div>
            ...
            <div className="relative flex flex-1 items-start">
                <div className="relative z-20 w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
                    <div className="flex flex-col">
                        ...
                        <p className="bold-20 text-white">Angella Mannie</p>
                    </div>
                    <div className="flexBetween">
                        <div className="flex flex-col">
